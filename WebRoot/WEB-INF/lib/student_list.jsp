    ...
    <div class="container" style="width:70%">
       ...
       <div>
				<form id="searchForm" action="${pageContext.request.contextPath}/student?method=searchByCondition" method="post">
					...
					姓名:<input type="text" id="name" name="name" value="${student.name}"/>
					年龄:<input type="text" id="age" name="age" value="${student.age}"/>
					...
					<a class="btn btn-primary"
						href="${pageContext.request.contextPath}/student/list.action">查询所有</a>
				</form>
			</div>
       <hr/>
               ...
               <c:forEach items="${list}" var="student">
                  <tr>
                      ...
                      <td><a href="javascript:void(0);"
                          onclick="delete('${student.getId()}')">删除</a>
                      </td>
                      <td><a
